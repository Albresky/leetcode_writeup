...
int main() {
    ...
    cout << "\nMemory Usage: " << getProcessMemory() << " Bytes" << endl;

    /**
     * Compile with Visual Studio 2022
     *
     * a) Write line 40 & line 44 outside of if-else branch:
     * `1 2 3 4 4 6
     *  Memory Usage: 5066752 Bytes`
     *
     * b) Write line 40 & line 44 inside of if-else branch:
     * `1 2 3 4 4 6
     *  Memory Usage: 5066752 Bytes`
     *  */
